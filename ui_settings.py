...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.framePresets.setFocusPolicy(Qt.NoFocus)
        ...
        self.frameSettings.setFocusPolicy(Qt.NoFocus)
